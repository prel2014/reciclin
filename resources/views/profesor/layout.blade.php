...
<head>
    ...
    <title>@yield('title', 'Dashboard') - Profesor Recipuntos</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="{{ url('/profesor/dashboard') }}" class="sidebar-logo">👨‍🏫 Recipuntos</a>
            <div class="sidebar-subtitle">Panel de Profesor</div>
        </div>

        <div class="sidebar-menu">
            <div class="menu-section">
                <div class="menu-section-title">Principal</div>
                <a href="{{ url('/profesor/dashboard') }}" class="menu-item {{ request()->is('profesor/dashboard') ? 'active' : '' }}">
            ...
            <div class="menu-section">
                <div class="menu-section-title">Mis Alumnos</div>
                <a href="{{ url('/profesor/alumnos') }}" class="menu-item {{ request()->is('profesor/alumnos*') ? 'active' : '' }}">
                    <span class="menu-item-icon">👨‍🎓</span>
            ...
            <div class="menu-section">
                <div class="menu-section-title">Tienda</div>
                <a href="{{ url('/profesor/productos') }}" class="menu-item {{ request()->is('profesor/productos*') ? 'active' : '' }}">
                    <span class="menu-item-icon">🎒</span>
                    <span>Ver Productos</span>
                </a>
                <a href="{{ url('/profesor/canjes') }}" class="menu-item {{ request()->is('profesor/canjes*') ? 'active' : '' }}">
                    <span class="menu-item-icon">🔄</span>
                    <span>Realizar Canjes</span>
                </a>
            </div>

            <div class="menu-section">
                <div class="menu-section-title">Reportes</div>
                <a href="{{ url('/profesor/historial') }}" class="menu-item {{ request()->is('profesor/historial*') ? 'active' : '' }}">
                    <span class="menu-item-icon">📋</span>
                    <span>Historial</span>
                </a>
            </div>
                    ...
                    if (!this.action.includes('/logout')) {
                        ...
                        if (submitBtn) {
                            ...
                            if (btnText.includes('Crear') || btnText.includes('Guardar')) {
                                ...
                                message = 'Eliminando...';
                            } else if (btnText.includes('Canje') || btnText.includes('Canjear')) {
                                message = 'Realizando canje...';
                            } else if (btnText.includes('Asignar')) {
                                message = 'Asignando Recipuntos...';
                            }
